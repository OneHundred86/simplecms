...
<div class="main-layout" id='main-layout'>
    ...
    <div class="main-layout-side">
        <div class="layui-nav-item" style="margin: 10px">
            <span style="font-size: 20px; color: white;">网站后台管理</span>
        </div>
        ...
        <div class="main-layout-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="rightNav">
                <li class="layui-nav-item mobile layui-hide-xs">
                    <a href="javascript:;" data-url="admin-info.html" data-text="个人信息">超级管理员</a>
                </li>
