...
@section('banner')
    ...
    <div class="layui-carousel" id="banner">
        <div carousel-item="">
            <div style="background-image: url(images/banner.jpg);background-repeat: no-repeat;background-size:100% 100%;"></div>
            <div style="background-image: url(images/ban_art.jpg);background-repeat: no-repeat;background-size:100% 100%;"></div>
        </div>
    </div>
            ...
            <div class="layout clearfix">
                ...
                <div class="words ind_tit">
                    ...
                    <p>广州迪川仪器仪表有限公司是一家专业工控仪表企业。以雄厚的资金为后盾，以高、新、尖的技术力量为核心。
                        在传感器、自控仪表、流量计及过程控制工艺等方面以诚信为本、平等互惠为原则，为客户创造成熟的产品及优质的服务。公司以产品的销售及提供工程技术服务并重的市场营销方式来满足用户的各种需求为已任。主要产品有：温度传感器，温度变送器，压力传感器，压力变送器，LWGY涡轮流量计（变送器），l涡街流量</p>
