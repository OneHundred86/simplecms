...
export type ArticleCreateRequest = Omit<
    Article,
    'id' | 'created_at' | 'updated_at' | 'read_cnt' | 'status' | 'covers'
> & { covers: string[] };
export type ArticleEditRequest = Omit<
    Article,
    'category' | 'created_at' | 'updated_at' | 'read_cnt' | 'status' | 'covers'
> & { covers: string[] };
